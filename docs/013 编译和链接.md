...
```shell
as -v -I ../include --32 -o /tmp/ccHEZDcE.o /tmp/ccRIpIcu.s
```
...
```shell
/usr/lib/gcc/x86_64-pc-linux-gnu/13.2.1/collect2 
```
...
COLLECT_GCC_OPTIONS='-v' '-m32' '-I' '../include' '-o' 'main.out' '-e' 'kernel_init' '-nostartfiles' '-mtune=generic' '-march=x86-64' '-dumpdir' 'main.out-'
 /usr/lib/gcc/x86_64-pc-linux-gnu/13.2.1/cc1 -quiet -v -I ../include -imultilib 32 main.c -quiet -dumpdir main.out- -dumpbase main.c -dumpbase-ext .c -m32 -mtune=generic -march=x86-64 -version -o /tmp/ccRIpIcu.s
