#ifndef PHINIX_DEVICE_H
#define PHINIX_DEVICE_H
...
enum device_cmd_t
{
    DEV_CMD_SECTOR_START = 1, // 获取设备扇区开始位置lba
    DEV_CMD_SECTOR_COUNT,     // 获取设备扇区数量
};
...
typedef struct device_t
{
    ...
    bool direct;         // 磁盘寻道方向
    // 设备控制
    int (*ioctl)(void *dev, int cmd, void *arg, int flags);
    // 读设备
