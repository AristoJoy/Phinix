...
INTERRUPT_HANDLER 0x03, 0   ; breakpoing

INTERRUPT_HANDLER 0x04, 0   ; overflow
INTERRUPT_HANDLER 0x05, 0   ; bound range expected
INTERRUPT_HANDLER 0x06, 0   ; invalid opcode
INTERRUPT_HANDLER 0x07, 0   ; device not available

INTERRUPT_HANDLER 0x08, 1   ; double falut
INTERRUPT_HANDLER 0x09, 0   ; coprocessor sement overrun
INTERRUPT_HANDLER 0x0a, 1   ; invalid TSS
INTERRUPT_HANDLER 0x0b, 1   ; segment not preset

INTERRUPT_HANDLER 0x0c, 1   ; stack sement fault
INTERRUPT_HANDLER 0x0d, 1   ; general protection falut
...
INTERRUPT_HANDLER 0x13, 0   ; SIMD floating - poing exception

INTERRUPT_HANDLER 0x14, 0   ; virtualization exception
INTERRUPT_HANDLER 0x15, 0   ; control protection exception
INTERRUPT_HANDLER 0x16, 0   ; reserved
INTERRUPT_HANDLER 0x17, 0   ; reserved

INTERRUPT_HANDLER 0x18, 1   ; reserved
INTERRUPT_HANDLER 0x19, 0   ; reserved
INTERRUPT_HANDLER 0x1a, 1   ; reserved
INTERRUPT_HANDLER 0x1b, 1   ; reserved

INTERRUPT_HANDLER 0x1c, 1   ; reserved
INTERRUPT_HANDLER 0x1d, 1   ; reserved
INTERRUPT_HANDLER 0x1e, 1   ; reserved
...
syscall_handler:
    ...
    push 0x80; 向中断处理函数传递参数中断向量vector
    ; xchg bx,bx
